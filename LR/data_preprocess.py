...
def load_data():
    ...
    pos_fname = 'd:\\Users\\CN096\\实验\\NLP\\实践作业1代码框架\\LR_framework\\标注语料\\positive\\'  # 请改为积极语料库实际路径
    neg_fname = 'd:\\Users\\CN096\\实验\\NLP\\实践作业1代码框架\\LR_framework\\标注语料\\negative\\'  # 请改为消极语料库实际路径
...
def get_data():
    global stopwords
    # 读取停用词列表：
    with open("d:\\Users\\CN096\\实验\\NLP\\实践作业1代码框架\\LR_framework\\stopwords.txt", encoding="utf-8") as f:
    ...
    word_vectors = KeyedVectors.load_word2vec_format("d:\\Users\\CN096\\实验\\NLP\\实践作业1代码框架\\LR_framework\\sgns.target.word-word.dynwin5.thr10.neg5.dim300.iter5.bz2")
    print("loading end")
